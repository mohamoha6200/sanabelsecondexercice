...
import 'package:sanabelsecondexercice/components/widgets/DogSlider.dart/dog_flare_controller.dart';
...
class _DogSliderState extends State<DogSlider> with TickerProviderStateMixin {
            ...
            Positioned(
              ...
              child: CustomPaint(
                foregroundPainter: DogSliderBgPainter(
                  ...
                  arcScaleY:
                      _ballAnim != null ? max(0, 1 - _ballAnim.value * 2) : 0.1,
  ...
  Widget _buildBallAndArrowStack() {
    return Stack(
      children: <Widget>[
        Image.asset(
          "assets/dog_slider/images/ball.png",
        ),
        Transform.translate(
          offset: Offset(26, -2),
  ...
  Widget _buildFlareActor() {
    ...
    var dogPosition = _dogPhysics!=null ?_dogPhysics.position : 0.0;
    print('dogPosition='+dogPosition.toString());
    var walkingDog = FlareActor(
      "assets/dog_slider/DogAnimation.flr",
    ...
    return Positioned(
      ...
      child: Container(
        ...
        transform: _dogPhysics !=null ? Matrix4.diagonal3Values(_dogPhysics.flipView ? -1 : 1, 1, 1): null,
        width: _dogWidth,
        height: _dogWidth,
        child: Transform(
          child: walkingDog,
  ...
  void handlePanDown() {
    _ballAnim.animateTo(1,
        duration: Duration(milliseconds: 300), curve: Curves.easeOutBack);
  }

  void handlePanEnd() {
    _ballAnim.animateTo(0,
        duration: Duration(milliseconds: 600), curve: ElasticOutCurve(.3));
  }
